package io.github.foo.repository;

import io.github.foo.FooApp;
import io.github.foo.config.Constants;
import io.github.foo.config.audit.AuditEventConverter;
import io.github.foo.domain.PersistentAuditEvent;
...
import static io.github.foo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
